...
// EXTERNAL MODULE: ./src/components/memory/memory.less
var memory = __webpack_require__(15);

// CONCATENATED MODULE: ./src/components/memory/memory.js
...
function Memory() {
  ...
  return react_default.a.createElement("div", null, react_default.a.createElement("button", {
    ...
    onClick: clickHandle
  }, "\u8DF3\u8F6C"), react_default.a.createElement("div", {
    onClick: clickToStepsHandle
  }, "\u8DF3\u8F6C"));
}
...
/* harmony default export */ var memory_memory = (Memory);
// CONCATENATED MODULE: ./src/memory.js
...
function createApp() {
  ...
  react_dom_default.a.render(react_default.a.createElement(memory_memory, null), container);
}
