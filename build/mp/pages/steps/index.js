...
function init(window, document) {require('../../common/vendors~index~log~steps.js')(window, document);require('../../common/vendors~steps.js')(window, document);require('../../common/steps.js')(window, document)}
