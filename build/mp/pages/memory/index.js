...
function init(window, document) {require('../../common/vendors~index~log~memory.js')(window, document);require('../../common/vendors~memory.js')(window, document);require('../../common/memory.js')(window, document)}
